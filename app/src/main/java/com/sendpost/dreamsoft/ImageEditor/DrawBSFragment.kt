...
class DrawBSFragment : BottomSheetDialogFragment(), SeekBar.OnSeekBarChangeListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_bottom_draw_dialog, container, false)
    }
